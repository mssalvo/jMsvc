...
,
        ...
        jMsvc.isAttribute = function (attrs) {
            for (a in attrs) {
	...
	for (t in context[fork[x]['attr']]) {	
                    ...
                    for (y in fork[x]['exp']) {
                        ...
                        if (jMsvc.isAttribute(elemExp.attributes)) { // if exp exp- attr
                            (function (a, b, c) {
                                                    ...
                                                    if (matchAttr[1]) {
                                                        switch (matchAttr[1]) {
                                                            case 'html':
                                                                ...
                                                                break;
                                                            case 'after':
                                                                this.$(elemExp).after(/^<(\w+)\s*\/?>(?:.* <\/\1>|)/.test(context[elementForEach][t][exps[e].split('.')[1]]) ? context[elementForEach][t][exps[e].split('.')[1]] : document.createTextNode(context[elementForEach][t][exps[e].split('.')[1]]))
                                                                break;
                                                            case 'before':
                                                        ...
                                                        if (matchAttr[1]) {
                                                            switch (matchAttr[1]) {
                                                                case 'html':
                                                                    ...
                                                                    break;
                                                                case 'after':
                                                                    this.$(elemExp).after(/^<(\w+)\s*\/?>(?:.* <\/\1>|)/.test(context[exps[e].split('.')[0]]) ? context[exps[e].split('.')[0]] : document.createTextNode(context[exps[e].split('.')[0]]))
                                                                    break;
                                                                case 'before':
                                                    ...
                                                    if (matchAttr[1]) {
                                                        switch (matchAttr[1]) {
                                                            case 'html':
                                                                ...
                                                                break;
                                                            case 'after':
                                                                this.$(elemExp).after(/^<(\w+)\s*\/?>(?:.* <\/\1>|)/.test(context[exps[e].split('.')[0]][exps[e].split('.')[1]]) ? context[exps[e].split('.')[0]][exps[e].split('.')[1]] : document.createTextNode(context[exps[e].split('.')[0]][exps[e].split('.')[1]]))
                                                                break;
                                                            case 'before':
